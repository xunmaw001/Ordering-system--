    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="菜品简介" prop="caipinjianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.caipinjianjie" label="菜品简介" prop="caipinjianjie">
                    <span>{{ruleForm.caipinjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.caipinxiangqing = this.ruleForm.caipinxiangqing.replace(reg,'../../../springbootjxb0e/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
